...
class ProvisionApplicationServiceAccountBadRequestException extends BadRequestException
{
    /**
    ...
    {
        parent::__construct('Invalid request or service account already exists');
