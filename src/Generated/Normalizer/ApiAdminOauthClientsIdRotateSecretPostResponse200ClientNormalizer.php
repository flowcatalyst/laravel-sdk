...
class ApiAdminOauthClientsIdRotateSecretPostResponse200ClientNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiAdminOauthClientsIdRotateSecretPostResponse200Client::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiAdminOauthClientsIdRotateSecretPostResponse200Client::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiAdminOauthClientsIdRotateSecretPostResponse200Client();
        ...
        if (\array_key_exists('applications', $data) && $data['applications'] !== null) {
            ...
            foreach ($data['applications'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, \FlowCatalyst\Generated\Model\ApiAdminOauthClientsIdRotateSecretPostResponse200ClientApplicationsItem::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiAdminOauthClientsIdRotateSecretPostResponse200Client::class => false];
    }
}