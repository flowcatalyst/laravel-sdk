...
class ApplicationServiceAccountCredentialsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApplicationServiceAccountCredentials::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApplicationServiceAccountCredentials::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \FlowCatalyst\Generated\Model\ApplicationServiceAccountCredentials();
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApplicationServiceAccountCredentials::class => false];
    }
}