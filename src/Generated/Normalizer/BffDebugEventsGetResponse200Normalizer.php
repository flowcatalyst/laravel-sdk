...
class BffDebugEventsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\BffDebugEventsGetResponse200::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\BffDebugEventsGetResponse200::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\BffDebugEventsGetResponse200();
        ...
        if (\array_key_exists('items', $data) && $data['items'] !== null) {
            ...
            foreach ($data['items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \FlowCatalyst\Generated\Model\BffDebugEventsGetResponse200ItemsItem::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\BffDebugEventsGetResponse200::class => false];
    }
}