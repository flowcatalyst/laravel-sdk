...
class ApplicationResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('hasLoginClient', $data) && \is_int($data['hasLoginClient'])) {
            $data['hasLoginClient'] = (bool) $data['hasLoginClient'];
        }
        ...
        if (\array_key_exists('hasLoginClient', $data) && $data['hasLoginClient'] !== null) {
            $object->setHasLoginClient($data['hasLoginClient']);
        }
        elseif (\array_key_exists('hasLoginClient', $data) && $data['hasLoginClient'] === null) {
            $object->setHasLoginClient(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['hasLoginClient'] = $data->getHasLoginClient();
