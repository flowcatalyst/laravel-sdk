...
class ApiAdminPrincipalsIdApplicationAccessGetResponse200ApplicationsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiAdminPrincipalsIdApplicationAccessGetResponse200ApplicationsItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiAdminPrincipalsIdApplicationAccessGetResponse200ApplicationsItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiAdminPrincipalsIdApplicationAccessGetResponse200ApplicationsItem();
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiAdminPrincipalsIdApplicationAccessGetResponse200ApplicationsItem::class => false];
    }
}