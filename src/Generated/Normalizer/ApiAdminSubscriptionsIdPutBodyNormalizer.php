...
class ApiAdminSubscriptionsIdPutBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiAdminSubscriptionsIdPutBody::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiAdminSubscriptionsIdPutBody::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiAdminSubscriptionsIdPutBody();
        ...
        if (\array_key_exists('eventTypes', $data) && $data['eventTypes'] !== null) {
            ...
            foreach ($data['eventTypes'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \FlowCatalyst\Generated\Model\ApiAdminSubscriptionsIdPutBodyEventTypesItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('customConfig', $data) && $data['customConfig'] !== null) {
            ...
            foreach ($data['customConfig'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \FlowCatalyst\Generated\Model\ApiAdminSubscriptionsIdPutBodyCustomConfigItem::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiAdminSubscriptionsIdPutBody::class => false];
    }
}