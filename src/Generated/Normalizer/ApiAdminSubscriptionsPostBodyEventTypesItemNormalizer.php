...
class ApiAdminSubscriptionsPostBodyEventTypesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiAdminSubscriptionsPostBodyEventTypesItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiAdminSubscriptionsPostBodyEventTypesItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiAdminSubscriptionsPostBodyEventTypesItem();
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiAdminSubscriptionsPostBodyEventTypesItem::class => false];
    }
}