...
class ApiAdminClientsByIdentifierIdentifierGetResponse200NotesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiAdminClientsByIdentifierIdentifierGetResponse200NotesItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiAdminClientsByIdentifierIdentifierGetResponse200NotesItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiAdminClientsByIdentifierIdentifierGetResponse200NotesItem();
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiAdminClientsByIdentifierIdentifierGetResponse200NotesItem::class => false];
    }
}