...
class ApiAdminClientsSearchGetResponse200ClientsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiAdminClientsSearchGetResponse200ClientsItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiAdminClientsSearchGetResponse200ClientsItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiAdminClientsSearchGetResponse200ClientsItem();
        ...
        if (\array_key_exists('notes', $data) && $data['notes'] !== null) {
            ...
            foreach ($data['notes'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \FlowCatalyst\Generated\Model\ApiAdminClientsSearchGetResponse200ClientsItemNotesItem::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiAdminClientsSearchGetResponse200ClientsItem::class => false];
    }
}