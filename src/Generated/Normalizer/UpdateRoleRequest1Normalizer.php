...
class UpdateRoleRequest1Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\UpdateRoleRequest1::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\UpdateRoleRequest1::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\UpdateRoleRequest1();
        ...
        if (\array_key_exists('permissions', $data) && $data['permissions'] !== null) {
            ...
            foreach ($data['permissions'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \FlowCatalyst\Generated\Model\PermissionInputDto1::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\UpdateRoleRequest1::class => false];
    }
}