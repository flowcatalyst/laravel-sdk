...
class ApiAdminOauthClientsIdRotateSecretPostResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('client', $data) && $data['client'] !== null) {
            $object->setClient($this->denormalizer->denormalize($data['client'], \FlowCatalyst\Generated\Model\ApiAdminOauthClientsIdRotateSecretPostResponse200Client::class, 'json', $context));
            unset($data['client']);
        }
