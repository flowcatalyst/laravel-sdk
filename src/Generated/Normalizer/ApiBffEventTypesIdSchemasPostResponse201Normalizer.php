...
class ApiBffEventTypesIdSchemasPostResponse201Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiBffEventTypesIdSchemasPostResponse201::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiBffEventTypesIdSchemasPostResponse201::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiBffEventTypesIdSchemasPostResponse201();
        ...
        if (\array_key_exists('specVersions', $data) && $data['specVersions'] !== null) {
            ...
            foreach ($data['specVersions'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \FlowCatalyst\Generated\Model\ApiBffEventTypesIdSchemasPostResponse201SpecVersionsItem::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiBffEventTypesIdSchemasPostResponse201::class => false];
    }
}