...
class SubscriptionDto1Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\SubscriptionDto1::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\SubscriptionDto1::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\SubscriptionDto1();
        ...
        if (\array_key_exists('eventTypes', $data) && $data['eventTypes'] !== null) {
            ...
            foreach ($data['eventTypes'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \FlowCatalyst\Generated\Model\EventTypeBinding::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\SubscriptionDto1::class => false];
    }
}