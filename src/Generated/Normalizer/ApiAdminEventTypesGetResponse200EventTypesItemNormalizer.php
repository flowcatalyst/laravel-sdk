...
class ApiAdminEventTypesGetResponse200EventTypesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \FlowCatalyst\Generated\Model\ApiAdminEventTypesGetResponse200EventTypesItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \FlowCatalyst\Generated\Model\ApiAdminEventTypesGetResponse200EventTypesItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \FlowCatalyst\Generated\Model\ApiAdminEventTypesGetResponse200EventTypesItem();
        ...
        if (\array_key_exists('specVersions', $data) && $data['specVersions'] !== null) {
            ...
            foreach ($data['specVersions'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \FlowCatalyst\Generated\Model\ApiAdminEventTypesGetResponse200EventTypesItemSpecVersionsItem::class, 'json', $context);
            }
    ...
    {
        return [\FlowCatalyst\Generated\Model\ApiAdminEventTypesGetResponse200EventTypesItem::class => false];
    }
}