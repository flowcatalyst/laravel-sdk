...
class GetEmailDomainMappingByDomain extends \FlowCatalyst\Generated\Runtime\Client\BaseEndpoint implements \FlowCatalyst\Generated\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{domain}'], [$this->domain], '/api/admin/email-domain-mappings/by-domain/{domain}');
    }
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (404 === $status) {
            throw new \FlowCatalyst\Generated\Exception\GetEmailDomainMappingByDomainNotFoundException($response);
        }
    }
