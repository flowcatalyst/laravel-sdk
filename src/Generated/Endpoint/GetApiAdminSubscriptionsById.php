...
class GetApiAdminSubscriptionsById extends \FlowCatalyst\Generated\Runtime\Client\BaseEndpoint implements \FlowCatalyst\Generated\Runtime\Client\Endpoint
{
    protected $id;
    /**
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (404 === $status) {
            throw new \FlowCatalyst\Generated\Exception\GetApiAdminSubscriptionsByIdNotFoundException($response);
        }
    }
