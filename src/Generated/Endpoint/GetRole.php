...
class GetRole extends \FlowCatalyst\Generated\Runtime\Client\BaseEndpoint implements \FlowCatalyst\Generated\Runtime\Client\Endpoint
{
    protected $id;
    /**
    ...
    {
        return str_replace(['{id}'], [$this->id], '/api/roles/{id}');
    }
