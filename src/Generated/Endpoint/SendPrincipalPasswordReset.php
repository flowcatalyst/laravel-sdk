...
class SendPrincipalPasswordReset extends \FlowCatalyst\Generated\Runtime\Client\BaseEndpoint implements \FlowCatalyst\Generated\Runtime\Client\Endpoint
{
    protected $id;
    /**
     * @param string $id
     ...
     */
    public function __construct(string $id, ?\FlowCatalyst\Generated\Model\SendPasswordResetInputBody $requestBody = null)
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \FlowCatalyst\Generated\Model\SendPasswordResetInputBody) {
