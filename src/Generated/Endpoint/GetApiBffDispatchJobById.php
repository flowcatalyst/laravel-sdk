...
class GetApiBffDispatchJobById extends \FlowCatalyst\Generated\Runtime\Client\BaseEndpoint implements \FlowCatalyst\Generated\Runtime\Client\Endpoint
{
    protected $id;
    /**
     * @param string $id
    ...
    {
        return str_replace(['{id}'], [$this->id], '/api/bff/dispatch-jobs/{id}');
    }
