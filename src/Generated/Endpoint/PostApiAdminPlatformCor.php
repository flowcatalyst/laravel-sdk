...
class PostApiAdminPlatformCor extends \FlowCatalyst\Generated\Runtime\Client\BaseEndpoint implements \FlowCatalyst\Generated\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\FlowCatalyst\Generated\Model\CreateCorsOriginRequest $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \FlowCatalyst\Generated\Model\CreateCorsOriginRequest) {
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \FlowCatalyst\Generated\Exception\PostApiAdminPlatformCorBadRequestException($response);
        }
    }
