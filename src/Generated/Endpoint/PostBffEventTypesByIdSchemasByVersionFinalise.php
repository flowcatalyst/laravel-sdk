...
class PostBffEventTypesByIdSchemasByVersionFinalise extends \FlowCatalyst\Generated\Runtime\Client\BaseEndpoint implements \FlowCatalyst\Generated\Runtime\Client\Endpoint
{
    protected $id;
    protected $version;
    /**
    ...
    {
        return str_replace(['{id}', '{version}'], [$this->id, $this->version], '/bff/event-types/{id}/schemas/{version}/finalise');
    }
