...
class UpdateEmailDomainMapping extends \FlowCatalyst\Generated\Runtime\Client\BaseEndpoint implements \FlowCatalyst\Generated\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $id, ?\FlowCatalyst\Generated\Model\UpdateMappingRequest $requestBody = null)
    {
        $this->id = $id;
    ...
    {
        if ($this->body instanceof \FlowCatalyst\Generated\Model\UpdateMappingRequest) {
