...
class PostBffRole extends \FlowCatalyst\Generated\Runtime\Client\BaseEndpoint implements \FlowCatalyst\Generated\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\FlowCatalyst\Generated\Model\CreateRoleRequest3 $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \FlowCatalyst\Generated\Model\CreateRoleRequest3) {
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \FlowCatalyst\Generated\Exception\PostBffRoleBadRequestException($response);
        }
    }
